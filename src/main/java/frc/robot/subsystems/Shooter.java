...
public class Shooter extends SubsystemBase {
  ...
  public void shooterMax(){
    m_SmallRoller.set(TalonFXControlMode.Velocity, SmartDashboard.getNumber("Small Roller High Goal", 9000));
    m_BigRoller.set(TalonFXControlMode.Velocity, SmartDashboard.getNumber("Big Roller High Goal", 9000));
  }
